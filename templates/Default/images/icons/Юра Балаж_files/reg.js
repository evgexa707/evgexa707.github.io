...
Go: function(){
		Page.Loading('start');
		$.post('/index.php?go=restore&act=ajax', function(data){
			Box.Show('albums', 464, 'Восстановление доступа к странице', data, lang_box_canсel, lang_album_create, 'StartCreatAlbum(); return false;', 0, 0, 1, 1);
			$('#name').focus();
			Page.Loading('stop');
		});
	},
