...
<div class="bg_block ">
<input type="text" value="Начните вводить любое слово или имя" class="fave_input" id="query_full" 
	onBlur="if(this.value==''){this.value='Начните вводить любое слово или имя';this.style.color = '#fff;';}" 
	onFocus="if(this.value=='Начните вводить любое слово или имя'){this.value='';this.style.color = '#fff'}" 
	onKeyPress="if(event.keyCode == 13)gSearch.go();" 
	style="width:685px;margin:0px;color:#fff; " 
maxlength="65" />
<div class="button_div fl_r"><button onClick="gSearch.go(); return false" style="
    margin-top: 1px;
    border-radius: 4px;
...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="margin-top:10px;height:22px">
 ...
 <div class="{activetab-3}"><a href="/?go=search{query-notes}" onClick="Page.Go(this.href); return false;"><div><b>Блоги</b></div></a></div>
</div>
