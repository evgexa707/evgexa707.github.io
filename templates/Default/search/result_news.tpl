...
<div class="wallrecord comm_wr news_comm_wr" id="wall_record_{rec-id}" style="padding-bottom:4px;margin-top:5px">
<div style="float:left;width:65px"><div class="ava_mini"><a href="/{link}{author-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" /></a><div style="position:absolute;margin-left:4px">{online}</div></div></div>
...
[wall]<div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}'[wall-func], 'uPages'[/wall-func])" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:615px">
