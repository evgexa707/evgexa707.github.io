            ...
            if(in_array(strtolower($type), $allowed_files)){
                ...
                if($file_size < 10000000){
                    ...
                    if(move_uploaded_file($file_tmp, $upload_dir.$downl_file_name.$res_type)){
                        ...
                        $db->query("UPDATE `vii_users` SET user_doc_num = user_doc_num+1 WHERE user_id = '{$user_id}'");
                        ...
                        //Вставляем файл в БД
                        $db->query("INSERT INTO `vii_doc` SET duser_id = '{$user_id}', dname = '{$file_name}', dsize = '{$dsize}', ddate = '{$server_time}', ddownload_name = '{$downl_file_name}{$res_type}', file_type = '{$type}', jpgif = '{$jpgif}'");
