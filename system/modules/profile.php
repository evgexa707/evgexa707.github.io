...
if($logged){
	...
	if($row){
		...
		//Если все хорошо, то выводим дальше
			...
			$verification = '<img onmouseover="myhtml.title(\'verifi\', \'Подтвёржденный пользователь ' . $row['user_searh_pref'] . ' \', \'\');" id="verifi" style="background:url(\'{theme}/images/verifi.png\');width:13px;height:11px;margin-left:5px;margin-top:-5px" src="{theme}/images/spacer.gif" />';
