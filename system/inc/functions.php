...
<head>
<title>Freend - Панель управления</title>
...
.logo{background:url("/templates/Default/images/logo.png") no-repeat;width:133px;height:48px;margin-left:5px}
...
<div class="clr"></div>
<div class="foot"><div style="margin-bottom:-10px"><a href="{$admin_link}" style="margin-right:10px">главная</a>{$stat_lnk}<a href="/" style="margin-right:10px" target="_blank">просмотр сайта</a>{$exit_lnk}</div><br />Freend<br />Copyright 2015 © </div>
</body>
</html>
HTML;
}
